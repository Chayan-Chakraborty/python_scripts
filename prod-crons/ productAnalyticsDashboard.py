...
filename = 'ProductAnalyticsDashboard.xlsx'
...
def main(environment_name, startDate, endDate):
    try : 
        ...
        if endDate:
            ...
            fetch_excel_data(db_config, (datetime.now() - timedelta(1)).strftime('%Y-%m-%d'), environment_name)
...
main('prod',None, None)
#main('prod', '2024-08-23' , '2024-08-26')
